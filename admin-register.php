...
<div class="row">
	...
	<h3 class="text-center text-uppercase animate__animated animate__fadeIn animate__slow animate__infinite infinite">Admin Registration</h3>
		...
		<div class="col-md-12 text-end">
			<input type="submit" class="btn btn-dark btn-sm" value="Register" name="btnAdminRegister"> <a href="index" type="button" class="btn btn-danger btn-sm">Back</a>
		</div>
