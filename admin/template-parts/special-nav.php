...
<!-- </button> -->
<div></div>
<h5 class="text-white d-md-block d-none ps-0 position-absolute ms-5 mt-2 animate__animated animate__fadeIn animate__slow animate__infinite infinite">E-commerce-Admin</h5>
...
<div class="offcanvas-body">
  ...
  <li class="nav-item">
    <a class="nav-link" href="category"><i class="fa-solid fa-list"></i> Add Category</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="checkouts"><i class="fa-solid fa-money-bill"></i> Orders</a>
  </li>
  <li class="nav-item">
  ...
  <li class="nav-item">
    <a href="reports" class="nav-link"><i class="fa-solid fa-chart-simple"></i> Reports</a>
  </li>
	</ul>
